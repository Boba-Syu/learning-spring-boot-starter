package cn.bobayu.hystrix;

import cn.bobayu.hystrix.annotation.DoHystrix;
import cn.bobayu.hystrix.valve.IValveService;
import cn.bobayu.hystrix.valve.impl.HystrixValveImpl;
...
public class DoHystrixPoint {
    @Pointcut("@annotation(cn.bobayu.hystrix.annotation.DoHystrix)")
